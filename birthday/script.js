...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const rsvpButton =  document.querySelector(".birthday-rsvp-button");
  console.log("RSVP button found:", rsvpButton);
  ...
  function updateRoster(characters = []) {
    ...
    // Always show example character first
    ...
    // Display actual characters if there are any
    if (count > 0) {
  ...
  if (rsvpButton) {
    console.log("RSVP button found.");
    rsvpButton.addEventListener("click", showRSVPModal);
  } else {
